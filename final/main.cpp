...
void first()
{
	...
	glColor3f(0.75, 0.75, 0.75);
	strokeString(50, 850, 0.15, 0.15, "NMAM INSTITUTE OF TECHNOLOGY", 2);
	strokeString(100, 750, 0.3, 0.3, "DEPARTMENT OF COMPUTER SCIENCE", 4);
	strokeString(300, 670, 0.3, 0.3, "AND ENGINEERING", 4);
	strokeString(200, 500, 0.3, 0.3, "COMPUTER GRAPHICS PROJECT ON", 2);
	glColor3f(0, 0.5, 0.5);
	...
	strokeString(650, 160, 0.18, 0.18, "Tarun Kumar - 4NM20CS200", 2);
	strokeString(650, 30, 0.2, 0.2, "Prof Puneeth R P", 2);
	strokeString(650, 120, 0.18, 0.18, "Ujjwal Karan - 4NM20CS202", 2);
	glutSwapBuffers();
}
...
{
	int rotatefan, mouserotate, sofatranslate, scalecompound, viewtype, housewall,lightsonoff;
	glutInit(&argc, argv);
